        ...
        <div className='w-full p-7'>
            <div className='shadow-lg p-4 py-6 flex gap-4 bg-[#fff]'>
                <div className='w-2/6 flex flex-col items-center justify-between'>
                    ...
                    {
                        fileLoading ? (
                            <button className="bg-amber-400 text-white text-base py-2 px-4 rounded cursor-not-allowed">Uploading...</button>
                        ) : uploaded === 1 ? (
                            <button className="bg-gray-400 text-white text-base py-2 px-4 rounded cursor-not-allowed">Uploaded</button>
                        ) : (
                            <button
                ...
                <div className='w-4/6'>
                    ...
                    <button
                        className="bg-blue-500 shadow-lg shadow-blue-500/50 text-white text-base py-2 px-4 rounded ml-4"
